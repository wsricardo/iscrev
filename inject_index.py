...
def update_file(filepath, is_pt):
    ...
    new_html = f'''<section class="main-section main-section-blog">
    <article class="card">
...
'''
    ...
    # If it already has the main-section-blog, we should replace it, otherwise insert it before </main>
    if '<section class="main-section main-section-blog">' in content:
        # It's already there, replace from <section class="main-section main-section-blog"> to its closing
        # Since the closing </section> is the one right before </main>, it's tricky.
        # But wait, we already know pt.html HAS it, and index.html DOESN'T have it.
        # Let's just run this for index.html which doesn't have it.
        pass
    else:
        # Insert before </main>
        content = content.replace('        </main>', f'{new_html}\n        </main>')
